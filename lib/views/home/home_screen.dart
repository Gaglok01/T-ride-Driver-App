          ...
          child: Column(
            ...
            children: [
              ...
              if (miles != null && toPickup) ...[
                SizedBox(height: 8.h),
                Text(
                  'Distance to rider: ${miles.toStringAsFixed(2)} mi',
                  style: TextStyle(
                    fontSize: 12.sp,
                    fontWeight: FontWeight.w800,
                  ),
              ...
              if (_arrivalCountdownSeconds > 0) ...[
                SizedBox(height: 8.h),
                Text(
                  'Waiting time: ${_formatCountdown(_arrivalCountdownSeconds)}',
                  style: TextStyle(
                    fontSize: 13.sp,
                    fontWeight: FontWeight.w900,
                    color: Colors.orange,
              ...
              if (_remainingDistanceText.isNotEmpty ||
                  _remainingDurationText.isNotEmpty) ...[
                SizedBox(height: 8.h),
                Row(
                  children: [
                    if (_remainingDistanceText.isNotEmpty)
                      _meta(Icons.route_rounded, _remainingDistanceText),
                    if (_remainingDistanceText.isNotEmpty &&
                        _remainingDurationText.isNotEmpty)
                      SizedBox(width: 8.w),
                    if (_remainingDurationText.isNotEmpty)
                      _meta(Icons.schedule_rounded, _remainingDurationText),
                  ],
                ),
              ],
