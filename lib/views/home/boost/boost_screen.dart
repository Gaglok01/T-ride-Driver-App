...
class _BoostScreenState extends State<BoostScreen> {
  ...
  late final _dailyIndex = DateTime.now()
  ...
  List<_Article> get _articles => const [
    _Article(
      ...
      summary:
          'Small habits that make riders feel safe, respected, and comfortable.',
      body: [
    ...
    _Article(
      ...
      summary:
          'Simple delivery habits that build trust and prevent complaints.',
      body: [
  ...
  List<_FunItem> get _funItems => const [
    _FunItem(
      'Driver joke of the day',
      'Why did the driver bring a ladder? Because the fare was going up.',
    ),
    _FunItem(
      'Quick challenge',
      'Today: complete your first 3 trips with a perfect greeting and smooth pickup.',
    ),
    _FunItem(
      'One-minute reset',
      'Before going online: breathe, check mirrors, check phone battery, and set your goal.',
    ),
    _FunItem(
      'T-Ride idea',
      'Ask one rider what would make local rides better. Great products listen first.',
    ),
  ];
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      'Learn, earn smarter, and discover opportunities with T-Ride.',
                      style: TextStyle(
                        fontSize: 12.5.sp,
                        height: 1.35,
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'Today’s free read: ${dailyTip.title}',
                      style: TextStyle(
                        fontSize: 12.5.sp,
                        fontWeight: FontWeight.w900,
                        color: AppConst.black,
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(18.r),
                border: Border.all(
                  color: active ? orange : Colors.black.withOpacity(.06),
                ),
              ),
              child: Row(
                children: [
    ...
    return Column(
      children: [
        ...
        _clickCard(
          ...
          'Airport demand playbook',
          'Best practices for airport pickups and scheduled trips.',
          () => _openInfo('Airport demand playbook', [
        ...
        _clickCard(
          ...
          'Downtown quick-trip strategy',
          'Learn how short trips can increase hourly earnings.',
          () => _openInfo('Downtown quick-trip strategy', [
        ...
        _sectionTitle(
          'Free daily content',
          'Something useful, light, or fun each day',
        ),
        _funCard(orange, fun),
  ...
  Widget _learn(Color orange) {
    return Column(
      ...
      children: [
        _sectionTitle(
          'Free driver learning',
          'Short lessons you can read anytime',
        ),
        ...
        _clickCard(
          ...
          '1-minute driver training clips',
          'Short videos can be connected later from YouTube, Vimeo, or T-Ride backend.',
          () => _openInfo('Mini video ideas', [
    ...
    return Column(
      children: [
        _sectionTitle(
          ...
          'Prepared for live dispatch data',
        ),
        _clickCard(
          orange,
          Icons.directions_car_rounded,
          'Ride opportunities',
          'Nearby requests will appear here when connected to dispatch.',
          () => _openInfo('Ride opportunities', [
        ...
        _clickCard(
          ...
          'Delivery hotspots',
          'Restaurants and delivery activity near you.',
          () => _openInfo('Delivery hotspots', [
        ...
        _clickCard(
          ...
          'Courier jobs',
          'Packages, documents, and urgent local delivery.',
          () => _openInfo('Courier jobs', [
        ...
        _clickCard(
          ...
          Icons.key_rounded,
          'Rental requests',
          'Vehicle and rental opportunities for approved drivers.',
          () => _openInfo('Rental requests', [
    ...
    return Column(
      children: [
        _sectionTitle(
          ...
          'Motivation for professional drivers',
        ),
        _bonusCard(
          orange,
          'Complete 10 rides',
        ...
        _bonusCard(
          orange,
          'Gold Driver progress',
          '3 more rides to next level',
          .72,
          () => _openInfo('Driver levels', [
        ...
        _bonusCard(
          orange,
          '5-star streak',
          'Keep your current service quality',
          .86,
          () => _openArticle(_articles.first),
        ),
        _clickCard(
          ...
          'Achievements',
          'Safe driver • Reliable partner • Fast responder',
          () => _openInfo('Achievements', [
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      height: 1.35,
                      fontWeight: FontWeight.w600,
                      color: AppConst.black.withOpacity(.55),
                    ),
                  ),
                ],
              ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4.h),
                  Text(
                    '${lesson.time} • ${lesson.summary}',
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      fontSize: 11.sp,
                      color: AppConst.black.withOpacity(.5),
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                ],
  ...
  Widget _funCard(Color orange, _FunItem item) {
    return GestureDetector(
      onTap: () => _openInfo(item.title, [
        item.text,
        'This section can refresh daily from Laravel later. For now it changes based on the day.',
      ]),
      child: Container(
        margin: EdgeInsets.symmetric(horizontal: 16.w, vertical: 6.h),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 10.5.sp,
                      color: AppConst.black.withOpacity(.48),
                      fontWeight: FontWeight.w600,
                    ),
                  ),
                ],
  ...
  void _openArticle(_Article article) {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => _BoostDetailScreen(article: article)),
    );
  }
  ...
  void _openInfo(String title, List<String> points) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => _InfoDetailScreen(title: title, points: points),
      ),
    );
  }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.h),
                Text(
                  '${article.time} • Free T-Ride learning',
                  style: TextStyle(
                    fontSize: 12.sp,
                    color: orange,
                    fontWeight: FontWeight.w800,
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 13.sp,
                    height: 1.45,
                    color: AppConst.black.withOpacity(.65),
                    fontWeight: FontWeight.w600,
                  ),
                ),
              ],
          ...
          SizedBox(height: 14.h),
          ...article.body.asMap().entries.map(
            (entry) => _pointCard(orange, entry.key + 1, entry.value),
          ),
        ],
      ),
    );
